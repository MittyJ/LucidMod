...
namespace LucidMod.Content.DamageClasses
{
	public class MonasticDamage : DamageClass
	{
		...
		public override void SetDefaultStats(Player player) {
			...
			player.GetCritChance<MonasticDamage>() += 4;
			player.GetArmorPenetration<MonasticDamage>() += 10;
