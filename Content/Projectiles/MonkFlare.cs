...
{
    public class MonkFlare : ModProjectile
    {
		...
		public override void AI() {
            ...
            Lighting.AddLight(Projectile.Center, Color.DarkBlue.ToVector3() * 0.55f * Main.essScale); // Makes this item glow when thrown out of inventory.
		}
